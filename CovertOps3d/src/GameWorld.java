...
public final class GameWorld {
   ...
   private static boolean isPointOnLeftSideOfLine(Point2D var0, Point2D var1, Point2D var2) {
      if (var1.x == var2.x) {
         if (var0.x <= var1.x) {
   ...
   public final boolean checkCollision(GameObject var1, Transform3D var2, SectorData var3) {
      ...
      for(var4 = 0; var4 < this.wallDefinitions.length; ++var4) {
         WallDefinition var5;
         if ((var5 = this.wallDefinitions[var4]).isCollidable() || isWallPassableForSector(var3, var5)) {
            this.resolveWallCollision(var5);
         }
      }
   ...
   public final WallDefinition handlePlayerMovement(PhysicsBody var1, SectorData var2) {
      ...
      int var6 = -1;
      WallDefinition var7;
      if (this.lastWallIndex != -1 && ((var7 = this.wallDefinitions[this.lastWallIndex]).isPassable() || isWallPassableForSector(var2, var7)) && this.resolveWallCollision(var7)) {
      ...
      for(var16 = 0; var16 < this.wallDefinitions.length; ++var16) {
         WallDefinition var8;
         if (var16 != this.lastWallIndex && ((var8 = this.wallDefinitions[var16]).isPassable() || isWallPassableForSector(var2, var8)) && this.resolveWallCollision(var8)) {
            if (var6 == -1) {
               var6 = var16;
            }
   ...
   private static boolean isWallPassableForSector(SectorData var0, WallDefinition var1) {
   ...
   private static boolean isWallSolid(WallDefinition var0) {
   ...
   private boolean resolveWallCollision(WallDefinition var1) {
      ...
      if (0 < var11) {
         ...
         if (0 < var13) {
            ...
            return this.adjustCollisionPoint(var11, var13, var2, var3, var1.normalVector, var6, var7, var8, var9);
         }
      }
   ...
   private boolean adjustCollisionPoint(int var1, int var2, Point2D var3, Point2D var4, Point2D var5, int var6, int var7, int var8, int var9) {
      int var10;
      int var10000;
      if (isPointOnLeftSideOfLine(this.collisionTestPoint, var3, var4)) {
         var10 = -var5.x;
         var10000 = -var5.y;
      } else {
         var10 = var5.x;
   ...
   public static boolean doLineSegmentsIntersect(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      long var8;
   ...
   private static boolean doesLineIntersectCircle(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      return doLineSegmentsIntersect(var0, var1, var2, var3, var4 - var6, var5 - var6, var4 + var6, var5 - var6) || doLineSegmentsIntersect(var0, var1, var2, var3, var4 + var6, var5 - var6, var4 + var6, var5 + var6) || doLineSegmentsIntersect(var0, var1, var2, var3, var4 + var6, var5 + var6, var4 - var6, var5 + var6) || doLineSegmentsIntersect(var0, var1, var2, var3, var4 - var6, var5 + var6, var4 - var6, var5 - var6);
   }
   ...
   public final boolean checkLineOfSight(Transform3D var1, Transform3D var2) {
      for(int var3 = 0; var3 < this.wallDefinitions.length; ++var3) {
         WallDefinition var4;
         if ((var4 = this.wallDefinitions[var3]).isSolid() || isWallSolid(var4)) {
            Point2D var5 = this.vertices[var4.startVertexId & '\uffff'];
            Point2D var6 = this.vertices[var4.endVertexId & '\uffff'];
            if (doLineSegmentsIntersect(var2.x, var2.z, var1.x, var1.z, var5.x, var5.y, var6.x, var6.y)) {
               return false;
            }
         }
      }
   ...
   public final void shootProjectile(Transform3D var1, SectorData var2) {
      int var3 = calculateAngleBetweenPoints(var1.x, var1.z, GameEngine.player.x, GameEngine.player.z);
   ...
   private boolean isProjectilePathBlocked(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var5 >> 16;
            ...
            for(var9 = 0; var9 < this.staticObjects.length; ++var9) {
               ...
               if ((var10 = this.staticObjects[var9]) != null && var10.aiState != -1) {
                  ...
                  if (this.checkLineOfSight(GameEngine.player, var11)) {
                     int var12 = 327680;
                     if (doesLineIntersectCircle(GameEngine.player.x, GameEngine.player.z, var6, var7, var11.x, var11.z, var12)) {
                        int var13;
                        label85: {
                           byte var19;
                           label84: {
                        ...
                        applyDamageToEnemy(var10, var13);
                        break;
                     }
                  }
               }
   ...
   private static void applyDamageToEnemy(GameObject var0, int var1) {
      var0.health -= var1;
      GameObject var10000;
      byte var10001;
      if (var0.health <= 0) {
         ...
         if ((var2 = (GameObject)this.projectiles.elementAt(var1)).objectType == 103) {
            ...
            for(var10 = 0; var10 < this.staticObjects.length; ++var10) {
               ...
               if ((var11 = this.staticObjects[var10]) != null && var11.aiState != -1) {
                  ...
                  if (doesLineIntersectCircle(var4, var5, var6, var7, var12.x, var12.z, var13)) {
                     applyDamageToEnemy(var11, var9);
                     var18 = true;
                  }
               }
            }
   ...
   private static int calculateAngleBetweenPoints(int var0, int var1, int var2, int var3) {
      int var4 = var2 - var0;
      int var5 = var3 - var1;
   ...
   public final void drawMapOnScreen(Graphics var1) {
